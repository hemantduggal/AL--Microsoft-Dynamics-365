/// <summary>
/// Report IncomeStatement (ID 50114).
/// </summary>
report 50114 "IncomeStatement"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'ReportLayout\IncomeStatement.rdl';//'./FinancialMgt/FinancialReports/AccountSchedule.rdlc';
