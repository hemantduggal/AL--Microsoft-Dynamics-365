/// <summary>
/// Report BalanceSheet (ID 50102).
/// </summary>
report 50113 "BalanceSheet"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'ReportLayout\BalanceSheet.rdl';//'./FinancialMgt/FinancialReports/AccountSchedule.rdlc';
            ...
            dataitem(Heading; "Integer")
            {
                ...
                dataitem("Acc. Schedule Line"; "Acc. Schedule Line")
                {
                    ...
                    dataitem("Column Layout"; "Column Layout")
                    {
                        ...
                        begin
                            // if "Acc. Schedule Line".SetRange(Detailed,true);
                            report.Run(85, Detailed);
...
#pragma warning restore AL0667
    ...
    /// <param name="NewDim3Filter">Text.</param>
    /// <param name="NewDim4Filter">Text.</param>
    /// <param name="CashFlowFilter">Text.</param>
